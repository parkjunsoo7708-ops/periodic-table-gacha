...
ELEMENTS = [
    ...
    ("Cm", "Curium",     96,  "SSR"),
    ("Bk", "Berkelium",      97,  "SSR"),
    ("Cf", "Californium",     98,  "SSR"),
    ("Es",  "Einsteinium",     99,  "SSR"),
    ("Fm", "fermium",      100,  "SSR"),
    ("Md", "Mendelevium",       101,  "SSR"),
    ("No", "Nobelium",      102,  "SSR"),
    ("Lr", "Lawrencium",     103,  "SSR"),
    ("Rf", "Rutherfordium",         104,  "SSR"),
    ("Db", "Dubnium",      105,  "SSR"),
    ("Sg", "Seaborgium",     106,  "SSR"),
    ("Bh", "Bohrium",         107,  "SSR"),
    ("Hs", "Hassium",      108,  "SSR"),
    ("Mt", "Meitnerium",     109,  "SSR"),
    ("Ds", "Darmstadtium",     110,  "SSR"),
    ("Rg", "Roentgenium",        111,  "SSR"),
    ("Cn", "Copernicium",     112,  "SSR"),
    ("Nh", "Nihonium",       113,  "SSR"),
    ("Fl", "Flerovium",     114,  "SSR"),
    ("Mc", "Moscovium",      115,  "SSR"),
    ("Lv", "Livermorium", 116,  "SSR"),
    ("Ts",  "Tennessine",      117,  "SSR"),
    ("Og", "Oganesson",    118,  "SSR"),
]
